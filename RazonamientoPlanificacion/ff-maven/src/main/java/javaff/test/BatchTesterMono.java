 ...
 *
 */
public abstract class BatchTesterMono
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			path = "C:\\Users\\PC-MIKE\\UNIR\\UNIR_actividades\\RazonamientoyPlainifcacion\\laboratorio";
			domain = "domain.pddl";
			pfileTemplate = "problem-base.pddl";
			
			outputBasePath = "C:\\Users\\PC-MIKE\\UNIR\\UNIR_actividades\\RazonamientoyPlainifcacion\\laboratorio\\salida";
		}
		catch (Exception e)
		{
			System.out.println(BatchTesterMono.Usage);
			System.exit(1);
		}
